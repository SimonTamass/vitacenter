...
define( 'VC_ELEMENTOR_HEADER_VERSION', '1.4.36' );
...
final class VitaCenter_Elementor_Header_Plugin {
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once VC_ELEMENTOR_HEADER_PATH . 'includes/class-vc-elementor-en-widgets.php';
		...
		VitaCenter_EN_Widgets::register( $widgets_manager );
	}
