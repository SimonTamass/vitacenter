...
final class VitaCenter_RO_Text {
	...
	private static function map() {
		...
		self::$map = array(
			...
			'EFI logó' => 'Logo BPPS',
			'EFI logó szélessége' => 'Lățime logo BPPS',
			'EFI név tipográfia' => 'Tipografie nume BPPS',
			'EFI szöveg színe' => 'Culoare text BPPS',
			...
			'Videók megjelenítése' => 'Afișare videoclipuri',
			'Beágyazott videók' => 'Videoclipuri încorporate',
			'Videós tartalmak a prevencióhoz, szűrésekhez és egészségtudatos döntésekhez.' => 'Conținut video pentru prevenție, screeninguri și decizii conștiente privind sănătatea.',
			'Videó címe' => 'Titlul videoclipului',
			'Videó URL vagy iframe kód' => 'URL video sau cod iframe',
			'YouTube/Vimeo URL-t vagy iframe beágyazási kódot is elfogad.' => 'Acceptă URL YouTube/Vimeo sau cod iframe de încorporare.',
			'Beágyazott videó' => 'Videoclip încorporat',
