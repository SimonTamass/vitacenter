...
final class VitaCenter_RO_Text {
	...
	private static function map() {
		...
		self::$map = array(
			...
			'Foglaljon időpontot, érdeklődjön programjainkról, vagy kérjen további tájékoztatást.' => 'Programați o consultație, solicitați informații despre programele noastre sau cereți detalii suplimentare.',
			...
			'Ügyfélfogadás' => 'Programări',
			'Egyeztessen időpontot!' => 'Programați o consultație!',
			'A programokon és tanácsadásokon való részvételhez kérjük, egyeztessen időpontot telefonon vagy e-mailben.' => 'Pentru participarea la programe și consiliere, vă rugăm să stabiliți o programare telefonic sau prin e-mail.',
			'Megközelítés' => 'Acces',
